...
class Graph():
    ...
    def get_edge(self, layout):
        if layout == "whole":
            ...
            neighbor_link = [(1, 0), (1, 2), (2, 3), (3, 4), (1, 5), (5, 6), 
            ...
            self.num_node = 21
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_link = [(0, 1), (1, 2), (2, 3), (3, 4), (0, 5), (5, 6), (6, 7), 
    ...
    def get_adjacency(self, strategy):
        ...
        if strategy == 'uniform':
            ...
            normalize_adjacency = normalize_digraph(adjacency)
            normalize_adjacency= np.tile(normalize_adjacency, (self.context, 1, 1)) # (num_node, k*num_node)
            A = np.zeros((self.context, self.num_node, self.num_node))
...
def normalize_digraph_context(A):
    Dl = np.sum(A, axis=0)   
    num_node, num_col = A.shape
    Dn = np.zeros((num_col, num_col))
